...
<div class="container">          
           <div class='panel panel-primary' style='width:70%; margin:20px auto; background-color:#FDFDFD;' >
                    <div class='panel-heading' style='background-color:#648DC3;' >
                        <div class="panel-title" ><div class="text-center"><h3>Student Project Upload</h3></div></div>
                    </div>     
<div class='panel-body' style='background-color:#EAE6E8;'>
<form class="form-group" action="studentproj_upload.php" method="post" onsubmit="return femo()" enctype="multipart/form-data" >
<div class="row">
					<div class="col-md-3">
				<strong><span style="color:#1C093C">Registration Number</span></strong>
					...
					<?php 
					$stid=$_SESSION['uid'];
					echo"<input type='number' name='reg_no' style='width:80%' value='$stid' class='form-control' required  readonly >";
				...
				<strong><span style="color:#1C093C">Subject</span></strong>
					...
					<div class="col-md-9" >
  <input type="text"  name='subject' value='<?php echo $_SESSION['subject12'];?>' style='width:80%' class="form-control" required readonly >
