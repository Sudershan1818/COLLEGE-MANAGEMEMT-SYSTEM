...
//$batch=$_POST['year_batch'];
 ...
 $mnth=date('M');
 $sql_stu="select * from student_detail where registration_number='$stid' ";
 $query_stu=mysql_query($sql_stu);
 $row_stu=mysql_fetch_array($query_stu);
 
 $sql="select * from attend_student where batch='$row_stu[8]' && branch='$row_stu[6]' && month='$mnth' && studentid='$stid' ";
